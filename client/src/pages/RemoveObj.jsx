...
axios.defaults.baseURL = import.meta.env.VITE_BASE_URL;axios.defaults.baseURL = import.meta.env.VITE_BASE_URL;
const RemoveObj = () => {
    ...
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      <form onSubmit={onSubmitHandler} className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-semibold">AI Object Removal Tool</h1>
        </div>
        ...
        <p className="mt-6 text-sm font-medium">Descride Your Object Name To Remove</p>
        ...
        rows={4}
          ...
          placeholder="e.g.,watch or spoon , any object name"
          required
        />
        ...
        >
          {loading ? <span className="w-4 h-4 my-1 rounded-full border-2 border-t-transparent animate-spin"></span> : <ScissorsIcon className="w-5"/>}
